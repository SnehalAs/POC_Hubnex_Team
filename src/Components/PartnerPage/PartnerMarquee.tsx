...
const ReviewCard = ({ img, name }: { img: string; name: string }) => {
  return (
    <figure
      className={cn(
        "relative w-64 cursor-pointer overflow-hidden  border p-4 rounded-2xl",
        // light styles
        "border-gray-950/[.1] bg-gray-950/[.01] hover:bg-gray-950/[.05] bg-white hover:text-white ",
        // dark styles
...
function PartnerMarquee() {
  return (
    <div className='control overflow-hidden relative bg-blue-600 rounded-none md:rounded-3xl'>
